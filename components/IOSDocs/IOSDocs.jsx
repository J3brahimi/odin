...
const IOSDocs = ({ title, image, link }) => {
    ...
    <>
      ...
      >
        ...
        <Typography
          ...
          sx={{ textDecoration: "none", color: "#000" }}
        >
          برای اتصال شما به برنامه Wings X نیاز دارید که میتوانید به صورت مستقیم
          از لینک زیر دانلود کنید.
        </Typography>
        <Typography
          component="a"
          href="https://apps.apple.com/us/app/wings-x/id6446119727"
          target="_blank"
      ...
      <Box
        ...
        mt={4}
      >
        <video src="/videos/wingsx.mp4" width="300" controls></video>
